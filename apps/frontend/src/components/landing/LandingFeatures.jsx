const FEATURES = [
  {
    ...
    description:
      'Suivi centralise des etudiants, candidatures et progression avec des tableaux clairs.',
  },
  {
    title: 'Opportunites ciblees',
    description:
      'Publication d offres par les partenaires et matching rapide avec les profils etudiants.',
  },
  {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="mt-3 text-zinc-600">
            Un design inspire du template, adapte a votre workflow LINK.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {FEATURES.map((feature) => (
            <article
              key={feature.title}
              className="card border-zinc-200 hover:shadow-md transition-shadow"
            >
