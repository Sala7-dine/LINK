    ...
    <div>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-white px-3 text-zinc-400 uppercase tracking-widest">ou avec email</span>
        </div>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-zinc-500">
        ...
        <Link to="/register-school" className="text-green-600 font-semibold hover:text-green-700 transition-colors">
          Inscrire une école
        </Link>
      </p>
    </div>
