                  ...
                  <div key={col.id} className="flex-shrink-0 w-80 flex flex-col max-h-full">
                    ...
                    <div className={`flex items-center gap-3 mb-4 px-1`}>
                      <div className="relative flex h-3 w-3">
                        <span
                          className={`animate-ping absolute inline-flex h-full w-full rounded-full ${col.dot} opacity-50`}
                        />
                        <span
                          className={`relative inline-flex rounded-full h-3 w-3 ${col.color}`}
                        />
                      </div>
