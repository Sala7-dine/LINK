...
export default function ProfilePage() {
  ...
  const inputClassName =
    'w-full px-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all shadow-sm placeholder:text-zinc-400 font-medium text-zinc-900';
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up pb-12">
        ...
        <div className="bg-white p-8 rounded-[24px] border border-zinc-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.05)] reveal-on-scroll flex flex-col sm:flex-row items-center sm:items-start gap-6 relative overflow-hidden">
          ...
          <div
            className="relative w-24 h-24 rounded-[10px] sm:rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white text-4xl font-bold overflow-hidden flex-shrink-0 shadow-lg shadow-green-500/30 z-10 group cursor-pointer"
          ...
          <div className="text-center sm:text-left z-10 mt-2">
            ...
            <div className="inline-flex">
              <span
                className={`text-xs font-bold px-3 py-1.5 rounded-full capitalize tracking-wide ${user?.role === 'school_admin' ? 'bg-orange-50 text-orange-600 border border-orange-100' : 'bg-green-50 text-green-700 border border-green-100'}`}
              >
                Rôle : {user?.role}
              </span>
            </div>
        ...
        <form
          ...
          className="bg-white p-6 sm:p-10 rounded-[24px] border border-zinc-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.05)] reveal-on-scroll space-y-6"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                {...register('email')}
                className={`${inputClassName} bg-zinc-100 text-zinc-500 cursor-not-allowed`}
                disabled
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              {...register('promotion')}
              className={inputClassName}
              placeholder="Ex: Étudiant en Développement Web, YouCode 2025"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className={inputClassName}
                placeholder="Ex: React, Vue, HTML, CSS"
              />
            </div>
            <div>
              ...
              <input
                ...
                className={inputClassName}
                placeholder="Ex: Node.js, Express, PHP, Laravel"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <input
                {...register('toolSkills')}
                className={inputClassName}
                placeholder="Ex: Git, Docker, MongoDB, Figma"
              />
            </div>
            <div>
              ...
              <input
                {...register('softSkills')}
                className={inputClassName}
                placeholder="Ex: Travail en équipe, Autonomie"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                {...register('hobbies')}
                className={inputClassName}
                placeholder="Ex: Football, Lecture, Open Source"
              />
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-zinc-100 flex justify-end">
            ...
            >
              <span className="relative z-10 transition-colors uppercase tracking-wider text-xs">
          ...
          <section className="space-y-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-12 mb-6">
              <div>
                ...
                <p className="text-zinc-500 mt-1">
                  Gérez vos stages et emplois et partagez-les avec le réseau.
                </p>
              </div>
              <button
                type="button"
              ...
              >
                <PlusIcon
                  className={`w-5 h-5 transition-transform duration-300 ${showExperienceForm ? 'rotate-45' : ''}`}
                />
            ...
            {showExperienceForm &&
              createPortal(
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 pb-20 sm:pb-6 bg-black/40 backdrop-blur-sm animate-fade-in-up">
                  ...
                  />
                  <form
                    onSubmit={handleExperienceSubmit(onSubmitExperience)}
                    className="bg-white/95 backdrop-blur-xl p-6 sm:p-10 rounded-[32px] border border-white/50 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] ring-4 ring-green-50/50 space-y-6 relative w-full max-w-2xl max-h-[90vh] overflow-y-auto"
                  >
                    <button
                      type="button"
                      onClick={() => setShowExperienceForm(false)}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          {...registerExperience('companyName', { required: true })}
                          className={inputClassName}
                          placeholder="Ex: Capgemini, Orange..."
                        />
                      </div>
                      <div>
                        <label className={labelClassName}>Type de contrat</label>
                        <select
                          {...registerExperience('experienceType', { required: true })}
                          className={inputClassName}
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                      <div>
                        ...
                        <input
                          type="date"
                          {...registerExperience('startDate', { required: true })}
                          className={inputClassName}
                        />
                      </div>
                      <div>
                        ...
                        <input
                          type="date"
                          {...registerExperience('endDate', { required: true })}
                          className={inputClassName}
                        />
                      </div>
                      <div>
                        ...
                        <input
                          {...registerExperience('location', { required: true })}
                          className={inputClassName}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        <label className={labelClassName}>
                          Lien LinkedIn de l'entreprise (Optionnel)
                        </label>
                        <input
                          {...registerExperience('companyLinkedinUrl')}
                          className={inputClassName}
                      ...
                      <div>
                        ...
                        <input
                          {...registerExperience('companyWebsiteUrl')}
                          className={inputClassName}
                          placeholder="https://..."
                        />
                      </div>
                    ...
                    <div className="pt-6 border-t border-zinc-100 flex justify-end gap-3">
                      <button
                        type="button"
                        onClick={() => setShowExperienceForm(false)}
                        className="px-6 py-3 font-bold text-zinc-600 hover:text-zinc-900 transition-colors uppercase tracking-widest text-xs"
                      >
                        Annuler
                      </button>
                      <button
                        type="submit"
                        className="bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold py-3 px-8 rounded-xl hover:shadow-lg hover:-translate-y-0.5 transition-all uppercase tracking-widest text-xs"
              ...
              {(myExperiences || []).length === 0 && !showExperienceForm && (
                <div className="bg-white/50 backdrop-blur-md border border-zinc-200 rounded-3xl p-12 text-center shadow-sm">
                  ...
                  <p className="text-zinc-400 mt-2">
                    Enrichissez votre CV en ajoutant vos stages récents.
                  </p>
                </div>
              )}
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-zinc-500 flex items-center gap-2">
                        <span className="text-green-600 bg-green-50 px-2 py-0.5 rounded uppercase tracking-wider text-[10px]">
                          {EXPERIENCE_TYPES.find((t) => t.value === experience.experienceType)
                  ...
                  {Array.isArray(experience.technologies) && experience.technologies.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {experience.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="text-[11px] px-2.5 py-1 rounded-lg border border-zinc-200 text-zinc-700 font-bold uppercase tracking-wider bg-zinc-50"
                        >
                          {tech}
                        </span>
                      ))}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-16 mb-6">
              <div>
                ...
                <p className="text-zinc-500 mt-1">
                  Ajoutez votre parcours scolaire, bootcamps et diplômes validés.
                </p>
              </div>
              <button
                type="button"
              ...
              >
                <PlusIcon
                  className={`w-5 h-5 transition-transform duration-300 ${showEducationForm ? 'rotate-45' : ''}`}
                />
            ...
            {showEducationForm &&
              createPortal(
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 pb-20 sm:pb-6 bg-black/40 backdrop-blur-sm animate-fade-in-up">
                  ...
                  />
                  <form
                    onSubmit={handleEducationSubmit(onSubmitEducation)}
                    className="bg-white/95 backdrop-blur-xl p-6 sm:p-10 rounded-[32px] border border-white/50 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] ring-4 ring-green-50/50 space-y-6 relative w-full max-w-2xl max-h-[90vh] overflow-y-auto"
                  >
                    <button
                      type="button"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          {...registerEducation('school', { required: true })}
                          className={inputClassName}
                          placeholder="Ex: YouCode, ENCG..."
                        />
                      </div>
                      <div>
                        <label className={labelClassName}>Diplôme / Parcours</label>
                        <input
                          {...registerEducation('degree', { required: true })}
                          className={inputClassName}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="date"
                          {...registerEducation('startDate', { required: true })}
                          className={inputClassName}
                        />
                      </div>
                      <div>
            ...
            <div className="space-y-4">
              {(user?.educations || []).length === 0 && !showEducationForm && (
                <div className="bg-white/50 backdrop-blur-md border border-zinc-200 rounded-3xl p-12 text-center shadow-sm">
                  <p className="text-zinc-500 text-lg">
                    Vous n'avez pas encore renseigné de formation.
                  </p>
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                    <div>
                      ...
                      <p className="text-sm font-semibold text-zinc-500">{edu.school}</p>
                    </div>
